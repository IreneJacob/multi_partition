 ...
 * @date 24-07-2019
 *
 * Based on the load-balancer example of DPDK
 * https://doc.dpdk.org/guides-18.08/sample_app_ug/load_balancer.html
 *
...
struct app_params {
  ...
  struct sockaddr_in server; // mine
};
...
int app_lcore_main_loop(void *arg); // gets called by main function
...
// TODO: deliver callback so that you can respond after writing to/ reading from
